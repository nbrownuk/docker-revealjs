...
- [`3.8.0-alpine`, `3-alpine`, `alpine` *(3.8.0/alpine/Dockerfile)*](https://github.com/nbrownuk/docker-revealjs/blob/3.8.0/alpine/Dockerfile)
- [`3.8.0-onbuild`, `3-onbuild`, `onbuild` *(3.8.0/onbuild/Dockerfile)*](https://github.com/nbrownuk/docker-revealjs/blob/3.8.0/onbuild/Dockerfile)
- [`3.8.0`, `3`, `latest` *(3.8.0/Dockerfile)*](https://github.com/nbrownuk/docker-revealjs/blob/3.8.0/Dockerfile)
...
```
FROM nbrown/revealjs:3.8.0-onbuild
```
